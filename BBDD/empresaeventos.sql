...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=2056159218ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=empresaeventos&table=actividades">`empresaeventos`.`actividades`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=empresaeventos&table=participantes">`empresaeventos`.`participantes`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=empresaeventos&table=lugar">`empresaeventos`.`lugar`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=empresaeventos&table=subeventos">`empresaeventos`.`subeventos`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=empresaeventos&table=detalleparticipante">`empresaeventos`.`detalleparticipante`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=empresaeventos&table=eventos">`empresaeventos`.`eventos`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="7e5b4f63675e782836214e567e383944">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="empresaeventos" targettable="participantes">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `participantes`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="empresaeventos" targettable="participantes">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `participantes`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="empresaeventos" targettable="detalleparticipante">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `detalleparticipante`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="empresaeventos" targettable="participantes">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `participantes`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="empresaeventos" targettable="subeventos">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `subeventos`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="empresaeventos" targettable="lugar">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `lugar`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="empresaeventos" targettable="eventos">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `eventos`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="empresaeventos" targettable="detalleparticipante">
                            <div class="action_content">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `detalleparticipante`</span>
                                            ...
                                            <div class="message history collapsed hide select"
                            targetdb="empresaeventos" targettable="actividades">
                            <div class="action_content">
                    <span class="action collapse">
            Collapse
                    </span>
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `actividades`</span>
                        </div>
                                            <div class="message history collapsed hide select"
                            targetdb="empresaeventos" targettable="detalleparticipante">
                            <div class="action_content">
